...
# --- Konfigurasi Data ---
TRAIN_FILE_PATH = "/home/victim/project/data/csv/slowpost.csv"
EVAL_FILE_PATH = "/home/victim/project/src/data/csv/slowpostvalidation_balanced.csv"
ATTACK_IP = "192.168.100.148"
...
def train_model(params, preprocessed_data,scaler):
    ...
    autoencoder.save(os.path.join(params['dir'], "slowpostautoencoder.h5"))
    joblib.dump(scaler, os.path.join(params['dir'], "slowpostscaler.gz"))
