...
# --- KONFIGURASI (DIUBAH UNTUK SLOWREAD) ---
PCAP_DIR = "../../data/pcap/"
CSV_DIR = "../../data/csv/"
PCAP_NAME = "slowreadvalidation.pcap" # Diubah dari slowloris
RAW_CSV_NAME = "slowreadvalidation_raw.csv" # Diubah dari slowloris
BALANCED_CSV_NAME = "slowreadvalidation_balanced.csv" # Diubah dari slowloris
INTERFACE = "ens18"

# --- IP GROUND TRUTH (TETAP SAMA) ---
