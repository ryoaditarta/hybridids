...
# --- KONFIGURASI (DIUBAH UNTUK SLOWPOST) ---
PCAP_DIR = "../../data/pcap/"
CSV_DIR = "../../data/csv/"
PCAP_NAME = "slowpostvalidation.pcap" # Diubah untuk slowpost
RAW_CSV_NAME = "slowpostvalidation_raw.csv" # Diubah untuk slowpost
BALANCED_CSV_NAME = "slowpostvalidation_balanced.csv" # Diubah untuk slowpost
INTERFACE = "ens18"

# --- IP GROUND TRUTH (DIUBAH SESUAI PERMINTAAN) ---
ATTACK_IP = "192.168.100.148" # IP penyerang baru
